...
<div class="container">
    ...
    <fieldset>
        <legend><?= __('Editar Turma de OTP') ?></legend>
        <?php
            echo $this->Form->control('configuraplanejamento_id', [
                ...
                'onchange' => "window.location = '" . $this->Url->build(['action' => 'edit', $turmaotp->id]) . "?configuraplanejamento_id=' + this.value",
            ]);
            echo $this->Form->control('turmaotp', ['label' => 'Turma']);
