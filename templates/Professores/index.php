...
<div class="container">
                ...
                <tr>
                    ...
                    <th>
                        ...
                        <?php if ($configuracaoAtual !== null): ?>
                            <small
                                class="text-muted">(<?= h($configuracaoAtual->semestre . ' - ' . ($configuracaoAtual->versao ?? '1')) ?>)</small>
                        <?php endif; ?>
                    </th>
                            ...
                            <?php if (isset($disponibilidades[$professor->id])): ?>
                                ...
                                <?php if ($disponibilidades[$professor->id]->motivo): ?>
                                    <small class="text-muted d-block"
                                        title="<?= h($disponibilidades[$professor->id]->motivo) ?>"><?= h($disponibilidades[$professor->id]->motivo) ?></small>
                                <?php endif; ?>
                            <?php else: ?>
    ...
    <nav aria-label="Paginação">
        ...
        <p><?= $this->Paginator->counter(__('Página {{page}} de {{pages}}, mostrando {{current}} registro(s) de {{count}} total')) ?>
        </p>
    </nav>
</div>