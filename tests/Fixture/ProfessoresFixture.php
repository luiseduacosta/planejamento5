...
class ProfessoresFixture extends TestFixture
{
    public array $fields = [
        ...
        'codigo_telefone' => ['type' => 'integer', 'null' => true],
        'telefone' => ['type' => 'string', 'length' => 20, 'null' => true],
        'codigo_celular' => ['type' => 'integer', 'null' => true],
        'celular' => ['type' => 'string', 'length' => 20, 'null' => true],
        'email' => ['type' => 'string', 'length' => 255, 'null' => true],
        'dataingresso' => ['type' => 'date', 'null' => true],
        'tipocargo' => ['type' => 'string', 'length' => 50, 'null' => true],
        'departamento' => ['type' => 'string', 'length' => 100, 'null' => true],
        'dataegresso' => ['type' => 'date', 'null' => true],
        'motivoegresso' => ['type' => 'string', 'length' => 255, 'null' => true],
