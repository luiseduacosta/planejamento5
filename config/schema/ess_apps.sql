...
CREATE TABLE IF NOT EXISTS `docentes` (
  ...
  `nome` varchar(200) CHARACTER SET latin1 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `cpf` char(14) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `siape` varchar(8) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cress` varchar(10) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `regiao` varchar(2) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codigo_telefone` char(2) CHARACTER SET latin1 COLLATE utf8mb4_general_ci NULL DEFAULT '21',
  `telefone` varchar(15) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codigo_celular` char(2) CHARACTER SET latin1 COLLATE utf8mb4_general_ci NULL DEFAULT '21',
  `celular` varchar(15) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `curriculolattes` varchar(50) CHARACTER SET latin1 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `atualizacaolattes` date NULL DEFAULT NULL,
  `dataingresso` date DEFAULT NULL,
  `tipocargo` varchar(20) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `departamento` varchar(30) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dataegresso` date DEFAULT NULL,
  `motivoegresso` varchar(100) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `observacoes` text CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `user_id` int(11) NULL DEFAULT 0,
  `estagiarios_count` int(10) unsigned NULL DEFAULT 0,
  `status` varchar(10) CHARACTER SET latin1 COLLATE utf8mb4_general_ci DEFAULT 'ativo',
